...
$sections = [
    ...
    ['type' => 'event-types', 'variant' => 'EventTypes4', 'data' => [
        ...
        'items' => [
            ...
            ['icon' => 'bi-star', 'title' => 'XV Años', 'text' => 'Una noche de cuento con pista de baile, lounge para fotos y decoración que refleja la personalidad de la quinceañera. Paquetes desde $22,000.'],
    ...
    ['type' => 'services', 'variant' => 'Services2', 'data' => [
        ...
        'items' => [
            ...
            ['icon' => 'bi-music-note-beamed', 'title' => 'Sonido profesional', 'desc' => 'Sistema de audio Bose con micrófonos inalámbricos y DJ booth equipado. Conecte su playlist por Bluetooth.', 'badge' => 'Incluido'],
            ['icon' => 'bi-flower1', 'title' => 'Floristería in house', 'desc' => 'Arreglos florales cultivados en nuestro propio vivero. Ramos, centros de mesa y decoración botánica personalizada.', 'badge' => 'Opcional'],
    ...
    ['type' => 'pricing', 'variant' => 'Pricing2', 'data' => [
        ...
        'plans' => [
            ...
            ['highlight' => true, 'name' => 'Magnolia', 'price' => '35,000', 'unit' => 'V-D · 8h', 'cta' => ['href' => '#contacto', 'label' => 'Cotizar'],
             'features' => ['8 horas de evento', 'Hasta 100 invitados', 'Mobiliario premium', 'Iluminación arquitectónica', 'Cocina + refrigeración', 'Coordinador dedicado', 'Sonido Bose', 'Lounge exterior', 'Estacionamiento + valet']],
            ['name' => 'Gala', 'price' => '55,000', 'unit' => 'V-D · 12h', 'cta' => ['href' => '#contacto', 'label' => 'Cotizar'],
             'features' => ['12 horas de evento', 'Hasta 120 invitados', 'Mobiliario de diseño', 'Iluminación DMX programable', 'Cocina + barra completa', 'Coordinador full-time', 'Sonido Bose + DJ booth', 'Lounge + terraza completa', 'Floristería in house', 'Proyector 4K y pantalla', 'Fotógrafo pre-evento', 'Estacionamiento + valet + vigilancia']],
        ],
    ...
    ['type' => 'gallery', 'variant' => 'Gallery5', 'data' => [
        ...
        'images' => [
            ...
            ['alt' => 'Área de lounge', 'full' => placeholder('1200x800', '1c1c1a', '8b9d83', 'Lounge+Magnolia'), 'thumb' => placeholder('200x120', '1c1c1a', '8b9d83', 'Lounge')],
    ...
    ['type' => 'faq', 'variant' => 'FAQ3', 'data' => [
        ...
        'items' => [
            ...
            ['icon' => 'bi-people', 'q' => '¿Capacidad máxima?', 'a' => '120 personas sentadas. El jardín tiene espacio para ceremonia de 100, la terraza techada cubre 80 y hay áreas de lounge para 40 adicionales.'],
