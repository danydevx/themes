  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg p-0">
      <a class="tb-header__logo navbar-brand" href="#">
        ...
        <?= esc($data['brand'] ?? 'Terraza Mi Cielo') ?>
      </a>
        ...
        <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
          ...
          <?php if (!empty($data['show_wa'])): ?>
            <li class="nav-item ms-lg-2">
              <a class="tb-btn tb-btn--whatsapp" href="<?= esc($data['wa_link'] ?? wa_link('Hola, me gustaría recibir información sobre ' . ($data['brand'] ?? 'Terraza Mi Cielo') . '.')) ?>" target="_blank" rel="noopener">
