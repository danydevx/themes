...
$sections = [
    ...
    ['type' => 'rooms', 'variant' => 'Rooms1', 'data' => [
        ...
        'note' => 'Hospedaje sujeto a disponibilidad. Se puede reservar como parte del paquete Total o por noche aparte. Consulte tarifas de hospedaje separately.',
    ]],
    ...
    ['type' => 'services', 'variant' => 'Services1', 'data' => [
        ...
        'items' => [
            ...
            ['col' => 'col-6 col-md-3', 'icon' => 'bi-music-note-beamed', 'title' => 'Sonido profesional', 'desc' => 'Sistema Bose de 4 zonas, micrófono inalámbrico y DJ booth básico.'],
            ['col' => 'col-6 col-md-3', 'icon' => 'bi-car-front', 'title' => 'Estacionamiento', 'desc' => 'Capacidad para 25 vehículos con vigilancia las 24 horas. Valet disponible.'],
            ['col' => 'col-6 col-md-3', 'icon' => 'bi-cup-hot', 'title' => 'Bar y bebidas', 'desc' => 'Barra equipped con refrigerador, hielera y licuadora. Servicio de bartender disponible.'],
    ...
    ['type' => 'event-types', 'variant' => 'EventTypes3', 'data' => [
        ...
        'items' => [
            ...
            ['img' => placeholder('800x500', 'd4e8c2', '7d8a5e', 'Ajijic+Paseo'), 'img_alt' => 'Paseo al pueblo de Ajijic',
             ...
             'text' => 'El encantador pueblo de Ajijic está a 15 minutos. Paseo opcional para grupos diurnos: callejuelas, galerías, cafés y restaurants. Servicio de shuttle disponible.'],
            ['img' => placeholder('800x500', 'f5efe6', 'b5673c', 'Fogata+Noche'), 'img_alt' => 'Fogata nocturna en Terraza Valle',
             ...
             'text' => 'Cierre la noche con una fogata junto al lago. Marshmallows, guitar flash mob o simplemente conversación bajo las estrellas. Incluida en paquetes Completo y Total.'],
        ],
    ]],
    ...
    ['type' => 'pricing', 'variant' => 'Pricing1', 'data' => [
        ...
        'plans' => [
            ['col' => 'col-md-6 col-lg-4',
             ...
             'features' => ['6 horas de evento', 'Jardín + terraza techada', 'Mobiliario básico', 'Estacionamiento', 'Vigilancia', 'Coordinador half-day', 'Fogón incluido'],
            ...
            ['col' => 'col-md-6 col-lg-4',
             ...
             'features' => ['12 horas de evento', 'Todas las áreas', 'Mobiliario diseño', 'Alberca + jacuzzi', 'Cocina de leña + barra', 'DJ booth básico', '4 habitaciones incl.', 'Coordinador + valet'],
             'cta' => ['href' => '#contacto', 'label' => 'Cotizar']],
        ],
    ...
    ['type' => 'testimonials', 'variant' => 'Testimonials1', 'data' => [
        ...
        'items' => [
            ...
            ['stars' => 5, 'text' => '"Buscaba algo diferente para mi despedida de soltera. Valle fue perfecto: la alberca de día, la fogata de noche y el pueblo de Ajijic para el paseo. Las chicas.lo.amaron."',
    ...
    ['type' => 'contact', 'variant' => 'Contact3', 'data' => [
        ...
        'fields' => [
            ...
            ['id' => 'tipo', 'label' => 'Tipo de evento', 'type' => 'select', 'options' => [
                ...
                ['label' => 'Retiro o ensimismada'], ['label' => 'Otro'],
            ]],
