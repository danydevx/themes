...
$sections = [
    ...
    ['type' => 'event-types', 'variant' => 'EventTypes1', 'data' => [
        ...
        'items' => [
            ...
            ['img' => placeholder('600x380', 'f5f0e6', 'b8963e', 'XV+Años'), 'img_alt' => 'XV Años en Terraza Analco', 'icon' => 'bi-star', 'title' => 'XV Años', 'text' => 'Una noche de ensueño con pista de baile iluminada, área para fotos y un jardín que parece sacado de una película.'],
    ...
    ['type' => 'faq', 'variant' => 'FAQ1', 'data' => [
        ...
        'items' => [
            ...
            ['icon' => 'bi-people', 'q' => '¿Capacidad máxima?', 'a' => '150 personas sentadas. El jardín principal cubre 120 invitados, la terraza techada 80, y hay áreas sociales para 30 adicionales. Contamos con mobiliario para todas las configuraciones.'],
            ...
            ['icon' => 'bi-music-note-beamed', 'q' => '¿Restricciones de horario y música?', 'a' => 'Música en vivo o DJ hasta la 1:00 AM en sábados, 12:00 AM entre semana. Después se permite música ambiental a volumen moderado hasta las 2 AM. Contamos con sistema Bose y cabina de DJ equipada.'],
