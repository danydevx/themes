<?php
/**
 * Terraza Oblatos Ocean — Festivo Familiar Variant.
 * Familia visual: Festivo Familiar (teal + coral + arena).
 * Colores: teal (#006d77) + coral (#83c5be) + arena (#edf6f9) + peach (#ffddd2).
...
$sections = [
    ...
    ['type' => 'header', 'variant' => 'Header3', 'data' => [
        ...
        'show_wa' => true,
        'wa_link' => wa_link('Hola, quiero información de Terraza Oblatos Ocean.'),
        'links' => [
    ...
    ['type' => 'hero', 'variant' => 'Hero10', 'data' => [
        ...
        'text' => 'Terraza Oblatos Ocean es el lugar donde los invitados no quieren irse. Alberca climatizada, jardín amplio y todo lo necesario para una celebración inolvidable.',
        'features' => [
        ...
        'cta_primary' => ['href' => wa_link('Hola, quiero agendar una visita en Terraza Oblatos Ocean.'), 'label' => 'Agendar visita'],
        'cta_secondary' => ['href' => '#alberca', 'label' => 'Conocer la alberca'],
        'image' => placeholder('900x700', '006d77', '83c5be', 'Oblatos+Ocean+Alberca'),
        'image_alt' => 'Terraza Oblatos Ocean con alberca climatizada',
    ...
    ['type' => 'about', 'variant' => 'About7', 'data' => [
        ...
        'subtitle' => 'Una alberca de 12 x 6 metros con sistema de climatización, cascada decorativa e iluminación LED. El lugar donde todos quieren estar.',
        'stats' => [
        ...
        'img' => placeholder('800x600', '006d77', 'e29578', 'Oblatos+Ocean+Alberca+Detalle'),
        'img_alt' => 'Alberca climatizada de Terraza Oblatos Ocean',
    ...
    ['type' => 'services', 'variant' => 'Services4', 'data' => [
        ...
        'items' => [
            ...
            ['title' => 'Jardín abierto', 'desc' => '400 m² de jardín con árboles y pasto. Para ceremonia o recepción al aire libre.'],
            ['title' => 'Cocina equipada', 'desc' => 'Estufa industrial, horno, refrigerador y área de servicio. Para catering o cocina propia.'],
            ['title' => 'Sonido y luces', 'desc' => 'Sistema de audio 600W, micrófono inalámbrico, luces DJ y efectos. Playlist o DJ.'],
    ...
    ['type' => 'event-types', 'variant' => 'EventTypes6', 'data' => [
        ...
        'items' => [
            ...
            ['icon' => 'bi-star', 'title' => 'XV Años', 'text' => 'La fiesta más importante de la adolescencia. Alberca, pista de baile, luces y todo lo que sueñe la quinceañera.', 'price' => 'Desde $22,000', 'price_note' => 'evento'],
    ...
    ['type' => 'gallery', 'variant' => 'Gallery7', 'data' => [
        ...
        'label' => 'Galería', 'title' => 'Así se ve una fiesta en Oblatos Ocean',
        'subtitle' => 'Momentos capturados en eventos reales. La alberca siempre es la protagonista.',
        'images' => [
            ['alt' => 'Alberca iluminada de noche', 'full' => placeholder('800x600', '006d77', '83c5be', 'Oblatos+Ocean+Noche'), 'thumb' => placeholder('400x400', '006d77', '83c5be', 'Oblatos+Ocean+Noche+Thumb')],
            ['alt' => 'Fiesta junto a la alberca', 'full' => placeholder('800x600', '83c5be', 'e29578', 'Oblatos+Ocean+Fiesta'), 'thumb' => placeholder('400x400', '83c5be', 'e29578', 'Oblatos+Ocean+Fiesta+Thumb')],
            ['alt' => 'Terraza con luces', 'full' => placeholder('800x600', '006d77', 'edf6f9', 'Oblatos+Ocean+Terraza'), 'thumb' => placeholder('400x400', '006d77', 'edf6f9', 'Oblatos+Ocean+Terraza+Thumb')],
            ['alt' => 'Cumpleaños junto a la alberca', 'full' => placeholder('800x600', 'e29578', '006d77', 'Oblatos+Ocean+Cumple'), 'thumb' => placeholder('400x400', 'e29578', '006d77', 'Oblatos+Ocean+Cumple+Thumb')],
            ['alt' => 'Jardín con decoración', 'full' => placeholder('800x600', '006d77', '83c5be', 'Oblatos+Ocean+Jardin'), 'thumb' => placeholder('400x400', '006d77', '83c5be', 'Oblatos+Ocean+Jardin+Thumb')],
            ['alt' => 'Área de descanso', 'full' => placeholder('800x600', '83c5be', 'e29578', 'Oblatos+Ocean+Descanso'), 'thumb' => placeholder('400x400', '83c5be', 'e29578', 'Oblatos+Ocean+Descanso+Thumb')],
        ],
    ...
    ['type' => 'testimonials', 'variant' => 'Testimonials8', 'data' => [
        ...
        'subtitle' => 'Más de 200 eventos realizados en Terraza Oblatos Ocean.',
        'items' => [
            ...
            ['stars' => 5, 'text' => 'El bautizo fue en la mañana y los niños pasaron toda la tarde en la alberca mientras los adultos comíamos. Todos quedaron encantados con el lugar.',
             'author' => 'Familia Sánchez', 'event' => 'Bautizo · Enero 2026'],
        ],
    ]],
    ...
    ['type' => 'faq', 'variant' => 'FAQ4', 'data' => [
        ...
        'items' => [
            ...
            ['icon' => 'bi-people', 'q' => '¿Cuántos invitados caben?', 'a' => 'Hasta 150 personas en la configuración completa. La alberca soporta 40-50 personas simultáneamente. La terraza techada cubre 80 y el jardín 100.'],
            ['icon' => 'bi-clock', 'q' => '¿Cuál es el horario de la fiesta?', 'a' => 'La renta incluye el acceso al espacio por 8 horas (paquete Oblatos). Los eventos pueden extender hasta las 2:00 AM. Música y DJ hasta las 12:00 AM.'],
        ...
        'cta_link' => wa_link('Hola, quiero apartar una fecha en Terraza Oblatos Ocean.'),
    ...
    ['type' => 'map', 'variant' => 'Map5', 'data' => [
        ...
        'cross_streets' => 'Entre Av. Toluquilla y Callejón del Edén',
        'phone' => '+52 33 1234 5678',
        'whatsapp' => wa_link('Hola, quiero información de Terraza Oblatos Ocean.'),
        ...
        'map_title' => 'Terraza Oblatos Ocean en Tlaquepaque',
    ...
    ['type' => 'contact', 'variant' => 'Contact3', 'data' => [
        ...
        'fields' => [
            ...
            ['id' => 'mensaje', 'label' => 'Mensaje', 'type' => 'textarea', 'placeholder' => 'Cuéntenos cómo imagina su fiesta en Oblatos Ocean.', 'col' => 'col-12', 'rows' => 3],
        ],
        'social' => [
            ['icon' => 'bi-facebook', 'href' => '#', 'label' => 'Facebook'],
            ['icon' => 'bi-instagram', 'href' => '#', 'label' => 'Instagram'],
            ['icon' => 'bi-tiktok', 'href' => '#', 'label' => 'TikTok'],
            ['icon' => 'bi-whatsapp', 'href' => wa_link('Hola, quiero información de Terraza Oblatos Ocean.'), 'label' => 'WhatsApp'],
        ],
        'hashtag' => 'OblatosOcean',
    ]],

    /* ═══ FOOTER ═══ */
    ['type' => 'footer', 'variant' => 'Footer7', 'data' => [
        'logo' => 'Oblatos Ocean',
        'logo_icon' => 'bi-droplet-fill',
        ...
        'social' => [
            ...
            ['icon' => 'bi-whatsapp', 'href' => wa_link('Hola, quiero información de Terraza Oblatos Ocean.'), 'target' => true, 'label' => 'WhatsApp'],
        ],
        'columns' => [
        ...
        'contact_items' => [
            ...
            ['icon' => 'bi-envelope', 'text' => 'hola@terrazaoblatosocean.com'],
        ],
        'copyright' => '© 2026 Terraza Oblatos Ocean. Todos los derechos reservados.',
        'legal_links' => [
...
$site = [
    'title' => 'Terraza Oblatos Ocean | Alberca climatizada para fiestas en Tlaquepaque',
    'desc' => 'Terraza Oblatos Ocean — Alberca climatizada, jardines y terraza techada para fiestas de cumpleaños, XV años, bodas y celebraciones hasta 150 invitados en Tlaquepaque, Jalisco.',
...
<body class="theme-oblatos-ocean">
