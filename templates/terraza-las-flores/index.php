...
$sections = [
        ...
        'categories' => [
            ...
            ['icon' => 'bi-house-heart', 'title' => 'Comodidades',
             'items' => [
                 ...
                 ['icon' => 'bi-check-circle-fill', 'label' => 'Área de lounge para adultos con sombra'],
    ...
    ['type' => 'pricing', 'variant' => 'Pricing2', 'data' => [
        ...
        'plans' => [
            ...
            ['highlight' => true, 'name' => 'Fiesta Completa', 'price' => '7,800', 'unit' => '50 niños', 'cta' => ['href' => '#contacto', 'label' => 'Reservar'],
             'features' => ['6 horas de evento', 'Brincolín + tobogán', 'Alberca climatizada', 'Mobiliario infantil + adulto', 'Mantelería premium', 'Piñata + dulces', 'Mesa de pastel decorada', 'Bocina + micrófono', 'Personal (2 meseros)', 'Vigilancia + valet', 'Pintacaritas', 'Coordinador de evento']],
            ['name' => 'Fiesta Total', 'price' => '9,800', 'unit' => '80 niños', 'cta' => ['href' => '#contacto', 'label' => 'Reservar'],
             'features' => ['8 horas de evento', '5 inflables', 'Alberca + tobogán', 'Mobiliario premium completo', 'Mantelería + decoración base', 'Piñata + mesa de dulces', 'Mesa de pastel temática', 'Sonido profesional + DJ', 'Personal (3 meseros + coord.)', 'Vigilancia + valet + fotógrafo', 'Pintacaritas + taller', 'Coordinador dedicado', 'Kit de bienvenida VIP', 'Limpieza post-evento']],
        ],
    ...
    ['type' => 'testimonials', 'variant' => 'Testimonials5', 'data' => [
        ...
        'items' => [
            ...
            ['author' => 'Mamá de Santiago', 'event' => 'Cumpleaños 3 años · Marzo 2026', 'text' => '"El chapoteadero para los más pequeños fue un éxito. Los abuelos disfrutaron el área de lounge con sombra mientras los niños jugaban. Muy seguro, muy limpio, muy bien organizado."', 'avatar' => placeholder('100x100', 'f4a261', 'fff', 'S')],
    ...
    ['type' => 'faq', 'variant' => 'FAQ2', 'data' => [
        ...
        'items' => [
            ...
            ['icon' => 'bi-people', 'q' => '¿Pueden asistir adultos?', 'a' => '¡Claro! El paquete incluye mobiliario para adultos en el área de lounge y jardín. Hay paquetes de comida para adultos disponibles. La fiesta es para los niños, pero queremos que los papás también la pasen bien.'],
        ],
